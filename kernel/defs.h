...
void            procdump(void);
pte_t*          random_physical_page(pagetable_t, struct pageondisk*);
uint            number_of_used_pages(pagetable_t);
uint            number_of_physical_pages(pagetable_t, struct pageondisk*);
uint64          move_random_page_to_disk(pagetable_t, struct pageondisk*);
uint64          init_next_page( pagetable_t, uint64, uint64, int);
pte_t*          last_used_page();
uint64          add_page(struct pageondisk*, pagetable_t, uint64, int, int, int);
...
uint64          uvmalloc(pagetable_t, struct pageondisk*, uint64, uint64, int);
